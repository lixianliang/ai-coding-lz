...
func TestCreateDocument(t *testing.T) {
	...
	doc, err := db.CreateDocument(ctx, docID, args)
	require.NoError(t, err)
...
func TestListChapterReadyDocuments(t *testing.T) {
	...
	db.CreateDocument(ctx, doc1, &api.CreateDocumentArgs{Name: "doc1"})
	db.CreateDocument(ctx, doc2, &api.CreateDocumentArgs{Name: "doc2"})
	db.CreateDocument(ctx, doc3, &api.CreateDocumentArgs{Name: "doc3"})
...
func TestUpdateDocumentFileID(t *testing.T) {
	...
	_, err := db.CreateDocument(ctx, docID, args)
	require.NoError(t, err)
